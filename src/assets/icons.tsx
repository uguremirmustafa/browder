...
const SvgIcon = (props: IProps) => {
  const { children, size = 24, className, viewBoxSize = 24 } = props;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox={viewBoxSize ? `0 0 ${viewBoxSize} ${viewBoxSize}` : '0 0 24 24'}
      width={size}
      height={size}
...
export const ClosedFolderIcon = (props: Icon) => (
  <SvgIcon {...props}>
    <path fill="none" d="M0 0h24v24H0z" />
